...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Maintaince By",url="https://t.me/Skull_Bots"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/Skull_Index_Bot"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Skull_Index_Help")
                ]
            ]
        )
